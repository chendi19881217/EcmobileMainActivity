...
public class TabsFragment extends Fragment {
	...
	void init(View mainView) {
		...
		this.tab_middle = (ImageView) mainView.findViewById(R.id.toolbar_tabmiddle);
		this.tab_middlebg = (ImageView) mainView.findViewById(R.id.toolbar_tabmiddlebg);
		this.tab_middle.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				OnTabSelected("tab_middle");
			}
		});
	...
	void OnTabSelected(String tabName) {
		if (tabName == "tab_one") {
			...
			if (null == homeFragment) {
				homeFragment = new B0_IndexFragment2();
			}
			...
			this.tab_one.setImageResource(R.drawable.table_1_pressed);
			this.tab_two.setImageResource(R.drawable.table_2_nomal);
			this.tab_three.setImageResource(R.drawable.table_4_nomal);
			this.tab_four.setImageResource(R.drawable.table_5_nomal);
			this.tab_middle.setImageResource(R.drawable.table_3_nomal);
			...
			this.tab_middlebg.setVisibility(View.INVISIBLE);
			...
			this.tab_one.setImageResource(R.drawable.table_1_nomal);
			this.tab_two.setImageResource(R.drawable.table_2_pressed);
			this.tab_three.setImageResource(R.drawable.table_4_nomal);
			this.tab_four.setImageResource(R.drawable.table_5_nomal);
			this.tab_middle.setImageResource(R.drawable.table_3_nomal);
			...
			this.tab_one.setImageResource(R.drawable.table_1_nomal);
			this.tab_two.setImageResource(R.drawable.table_2_nomal);
			this.tab_three.setImageResource(R.drawable.table_4_pressed);
			this.tab_four.setImageResource(R.drawable.table_5_nomal);
			this.tab_middle.setImageResource(R.drawable.table_3_nomal);
			...
			this.tab_two.setImageResource(R.drawable.table_2_nomal);
			this.tab_three.setImageResource(R.drawable.table_4_nomal);
			this.tab_four.setImageResource(R.drawable.table_5_pressed);
			this.tab_middle.setImageResource(R.drawable.table_3_nomal);
		...
		else if (tabName == "tab_middle") {

			zxing_Fragment = new Zxing_Fragment();
			FragmentTransaction localFragmentTransaction = getFragmentManager().beginTransaction();
			localFragmentTransaction.replace(R.id.fragment_container, zxing_Fragment, "tab_middle");
			localFragmentTransaction.commit();
			...
			this.tab_three.setImageResource(R.drawable.table_4_nomal);
			this.tab_four.setImageResource(R.drawable.table_5_nomal);
			this.tab_middle.setImageResource(R.drawable.table_3_pressed);
			...
			this.tab_threebg.setVisibility(View.INVISIBLE);
			this.tab_fourbg.setVisibility(View.INVISIBLE);
			this.tab_middlebg.setVisibility(View.VISIBLE);
