...
public class B0_IndexFragment2 extends BaseFragment implements
		BusinessResponse, XListView.IXListViewListener, RegisterApp {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		headUnreadTextView = (TextView) mainView
				.findViewById(R.id.head_unread_num);
		...
		bannerView = (FrameLayout) LayoutInflater.from(getActivity()).inflate(
				R.layout.b0_index_banner, null);
		...
		bannerViewPager
				.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
					...
					public void onPageScrollStateChanged(int state) {
						// All of this is to inhibit any scrollable container
						// from
						// consuming our touch events as the user is changing
						// pages
	...
	public void addBannerView() {
		...
		for (int i = 0; i < 4; i++) {
			...
			ImageView viewOne = (ImageView) LayoutInflater.from(getActivity())
			...
			case 0:
				...
				viewOne.setImageResource(R.drawable.a1);

				break;

			case 1:

				viewOne.setImageResource(R.drawable.a2);

				break;

			case 2:

				viewOne.setImageResource(R.drawable.a3);

				break;

			case 3:

				viewOne.setImageResource(R.drawable.a4);
			...
			// imageLoader.displayImage(player.photo.thumb, viewOne,
			// EcmobileApp.options);
			// } else if (imageType.equals("low")) {
			// imageLoader.displayImage(player.photo.small, viewOne,
			// EcmobileApp.options);
			// } else {
	...
	// // .valueOf(player1.action_id);
	// // intent.putExtra(B1_ProductListActivity.FILTER,
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				convertView = inflater.inflate(
						R.layout.b0_index_category_cell_adapte_layout, null);
				hv = new HoldeView();

				hv.top_image = (ImageView) convertView
						.findViewById(R.id.top_image);

				hv.two_content = (LinearLayout) convertView
						.findViewById(R.id.two_content);
				hv.two_left = (ImageView) convertView
						.findViewById(R.id.two_left);
				hv.two_right = (ImageView) convertView
						.findViewById(R.id.two_right);

				// 两个一组
				hv.left_right_content = (LinearLayout) convertView
						.findViewById(R.id.left_right_content1);
				hv.good_left = (ImageView) convertView
						.findViewById(R.id.good_left1);
				hv.good_right = (ImageView) convertView
						.findViewById(R.id.good_right1);
			...
			case 0:
				...
				if (imageType.equals("high")) {
					imageLoader.displayImage(list.get(position).get("thumb"),
							hv.top_image, EcmobileApp.options);
				} else if (imageType.equals("low")) {
					...
					if (netType.equals("wifi")) {
						imageLoader.displayImage(list.get(position)
								.get("thumb"), hv.top_image,
								EcmobileApp.options);
					} else {
						imageLoader.displayImage(list.get(position)
								.get("small"), hv.top_image,
								EcmobileApp.options);
					}
				}
			...
			case 1:
				...
				if (imageType.equals("high")) {
					imageLoader.displayImage(list.get(position).get("thumb"),
							hv.two_left, EcmobileApp.options);
				} else if (imageType.equals("low")) {
					imageLoader.displayImage(list.get(position).get("small"),
							hv.two_left, EcmobileApp.options);
				} else {
					...
					if (netType.equals("wifi")) {
						imageLoader
								.displayImage(list.get(position).get("thumb"),
										hv.two_left, EcmobileApp.options);
					} else {
						imageLoader
								.displayImage(list.get(position).get("small"),
										hv.two_left, EcmobileApp.options);
					}
				}
				...
				if (imageType.equals("high")) {
					imageLoader.displayImage(list.get(position).get("thumb1"),
							hv.two_right, EcmobileApp.options);
				} else if (imageType.equals("low")) {
					...
					if (netType.equals("wifi")) {
						imageLoader.displayImage(
								list.get(position).get("thumb1"), hv.two_right,
								EcmobileApp.options);
					} else {
						imageLoader.displayImage(
								list.get(position).get("small1"), hv.two_right,
								EcmobileApp.options);
					}
				}
			...
			case 3:
				...
				if (imageType.equals("high")) {
					imageLoader.displayImage(list.get(position).get("thumb"),
							hv.pattner, EcmobileApp.options);
				} else if (imageType.equals("low")) {
					imageLoader.displayImage(list.get(position).get("small"),
							hv.pattner, EcmobileApp.options);
				} else {
					...
					if (netType.equals("wifi")) {
						imageLoader.displayImage(list.get(position)
								.get("thumb"), hv.pattner, EcmobileApp.options);
					} else {
						imageLoader.displayImage(list.get(position)
								.get("small"), hv.pattner, EcmobileApp.options);
					}
				}
			...
			case 4:
				...
				if (imageType.equals("high")) {
					...
					if (netType.equals("wifi")) {
						imageLoader.displayImage(list.get(position)
								.get("thumb"), hv.item, EcmobileApp.options);
					} else {
						imageLoader.displayImage(list.get(position)
								.get("small"), hv.item, EcmobileApp.options);
					}
				}
	...
	public void initViewBG(String url_thumb, String url_small, ImageView v,
