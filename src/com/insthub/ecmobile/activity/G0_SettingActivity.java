...
public class G0_SettingActivity extends BaseActivity implements OnClickListener, BusinessResponse {
	...
	private LinearLayout settingChechVersion;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		settingChechVersion = (LinearLayout) findViewById(R.id.check_version);
		settingChechVersion.setOnClickListener(this);
		...
		if (null != ConfigModel.getInstance().config && null != ConfigModel.getInstance().config.service_phone) {
	...
	public void onClick(View v) {
			...
			mDialog.positive.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent(Intent.ACTION_CALL,
							Uri.parse("tel:" + ConfigModel.getInstance().config.service_phone));
		...
		case R.id.check_version:
			...
			CheckVersionUtil checkVersionUtil = new CheckVersionUtil(context, handler, APKPathEntity.apk_info_path);
