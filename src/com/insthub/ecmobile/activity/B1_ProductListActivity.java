...
public class B1_ProductListActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public boolean onEditorAction(TextView v, int actionId,
				...
				if (actionId == EditorInfo.IME_ACTION_SEARCH) {
					...
					if (null != keyword && keyword.length() > 0) {
						...
						dataModel
								.fetchPreSearch(B1_ProductListActivity.this.filter);
					} else {
			...
			public void onClick(View v) {
				...
				if (uid.equals("")) {
					...
					ToastView toast = new ToastView(
							B1_ProductListActivity.this, nol);
					toast.setGravity(Gravity.CENTER, 0, 0);
					toast.show();
				} else {
					Intent it = new Intent(B1_ProductListActivity.this,
							C0_ShoppingCartActivity.class);
					startActivity(it);
				}
			}
		});
		...
		if (ShoppingCartModel.getInstance().goods_num == 0) {
			...
			if (ShoppingCartModel.getInstance() != null) {
				good_list_shopping_cart_num.setText(ShoppingCartModel
		...
		largeListActivityAdapter = new GoodListLargeListActivityAdapter(this,
	...
	void selectedTab(int index) {
		...
		if (index == IS_HOT) {
			...
			tabTwoCellHolder.orderIconImageView
					.setImageResource(R.drawable.item_grid_filter_down_arrow);
			...
			tabThreeCellHolder.orderIconImageView
					.setImageResource(R.drawable.item_grid_filter_up_arrow);
			...
			tabThreeCellHolder.orderIconImageView
					.setImageResource(R.drawable.item_grid_filter_up_active_arrow);
